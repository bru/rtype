...
Story: Creating an account
  ...
  Scenario: Anonymous user can start creating an account
    ...
    Then  she should be at the 'authors/new' page
  ...
  Scenario: Anonymous user can create an account
    Given an anonymous user
     And  no author with login: 'Oona' exists
    ...
    Then  she should see a notice message 'Thanks for signing up!'
     And  an author with login: 'oona' should exist
     And  the author should have login: 'oona', and email: 'unactivated@example.com'
  ...
  Scenario: Anonymous user can not create an account replacing an activated account
    ...
    Then  she should be at the 'authors/new' page
     ...
     And  a author with login: 'reggie' should exist
     And  the author should have email: 'registered@example.com'

     And  the author's created_at should stay the same under to_s
     And  the author's updated_at should stay the same under to_s
  ...
  Scenario: Anonymous user can not create an account with incomplete or incorrect input
    ...
    Then  she should be at the 'authors/new' page
     ...
     And  no author with login: 'oona' should exist
